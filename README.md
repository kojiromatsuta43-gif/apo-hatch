...
3. **CSVを取り込む** — 列: 企業名 / 問い合わせフォーム / 企業URL / メール / 大業界 / 小業界 / 都道府県 / 代表者名（企業DBの書き出しそのまま可）。同一ドメイン・90日以内送信済み・除外リスト・配信停止・官公庁は自動で振り分け
